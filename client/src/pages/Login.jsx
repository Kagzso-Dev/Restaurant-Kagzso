...
const Login = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-start sm:justify-center min-h-[100dvh] bg-[var(--theme-bg-dark)] relative overflow-y-auto overflow-x-hidden pt-safe pb-safe py-8 sm:py-0">
            {/* Background Effects */}
            ...
            {/* Logo Section */}
            <div className="mb-8 z-10 flex flex-col items-center animate-fade-in-down px-4 text-center mt-4 sm:mt-0">
                {/* Logo + Name Row */}
            ...
            {/* Footer */}
            <div className="mt-auto sm:mt-8 py-6 text-center text-[10px] sm:text-xs text-[var(--theme-text-subtle)] z-10 w-full px-4">
