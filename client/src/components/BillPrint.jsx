...
export const printBill = (order, formatPrice, settings = {}, isKOT = false) => {
...
<head>
<meta charset="UTF-8">
<title>${isKOT ? 'KOT' : 'Bill'} — ${order.orderNumber}</title>
<style>
...
<div class="row"><span>${isKOT ? 'KOT' : 'Order ID'}</span><span class="bold">${order.orderNumber}</span></div>
