    ...
    <>
      <style>{`
        ...
        @media (max-width: 480px) {
          ...
          .hero-contact-bar { padding: 8px 12px; gap: 10px; justify-content: center; }
      ...
      <section className="hero-section">
        ...
        <div className="hero-content">
          ...
          {/* Headline */}
          <h1 className="hero-headline hero-anim hero-delay-2">
            Smart Kitchen &amp; Order
            <br />
          ...
          {/* Subtitle */}
          <p className="hero-subtitle hero-anim hero-delay-3">
            From table to kitchen in seconds. Manage orders, track kitchen stages,
            and streamline billing — all in one place.
          </p>

          {/* CTA buttons */}
          <div className="hero-cta-group hero-anim hero-delay-4">
            <button
              onClick={() => setShowDemo(true)}
              className="hero-btn-demo"
              onMouseEnter={(e) => { e.currentTarget.style.transform = 'scale(1.05)'; e.currentTarget.style.boxShadow = '0 8px 32px rgba(255,107,53,0.6)'; }}
              onMouseLeave={(e) => { e.currentTarget.style.transform = 'scale(1)'; e.currentTarget.style.boxShadow = '0 6px 24px rgba(255,107,53,0.45)'; }}
            >
          ...
          <div className="hero-stats">
            {STATS.map((stat, i) => (
              <div
                key={i}
                className={`hero-stat-card hero-float hero-float-delay-${i}`}
              >
